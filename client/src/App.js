...
function ChildApp() {
  ...
  return (
      ...
      {customers.length!=0 &&<Stats customers = {customers}/>}
      {customers.length!=0 && <Table handleClick={handleModalClick} customers={customers} />}
      {customers.length!=0 && <OrderDistribution customers={customers} />}
      {customers.length!=0 && <Insert />}
